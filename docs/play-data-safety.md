...
- No networking libraries are present in dependencies (pubspec.yaml contains only flutter_riverpod, riverpod_annotation, drift, sqlite3_flutter_libs, path_provider, path, go_router, flutter_local_notifications, timezone, flutter_timezone, package_info_plus).
